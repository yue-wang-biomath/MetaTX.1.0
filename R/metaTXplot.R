#' Visualize the density distribution of genomic features on an mRNA model.
#' @export metaTXplot
#' @import ggplot2
#' @importFrom stats aggregate
#' @importFrom methods is
#' @description Visualize the density distribution of genomic features on an mRNA model. The density distribution is an EM solution that corrects isoform ambiguity among mRNAs.
#' @usage metaTXplot(remap_results, includeNeighborDNA = TRUE, relativeProportion = c(1, 1, 1, 1),
#' lambda = 0, adjust = 0.15, title  = '', legend = '', returnPlot = TRUE, type = 'relative',
...
metaTXplot <-
  function(    remap_results,
    ...
    if(!is(remap_results, 'remap.results')){
      stop("Argument remap_results must be a remap.results object.")
    }
